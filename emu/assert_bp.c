...
/***************************************************************************/
BPLONG numberVarCopyToParea(BPLONG term, BPLONG_PTR varno)
{
...
BPLONG numberVarCopyListToParea(BPLONG term, BPLONG_PTR varno)
{
...
/* term in the form of (a,b,...) */
BPLONG numberVarCopyCommaToParea(BPLONG term, BPLONG_PTR varno)
{
