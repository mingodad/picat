...
In Picat, predicates\index{predicate} and functions\index{function} are defined with rules. Picat has two types of pattern-matching rules: the \emph{non-backtrackable} rule\index{non-backtrackable rule} 
\begin{tabbing}
