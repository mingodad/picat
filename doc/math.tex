...
\item \texttt{tan($X$) = $Val$}\index{\texttt{tan/1}}: This function returns the tangent of $X$, where $X$ is given in radians.  If the tangent is undefined, such as at \texttt{pi / 2}, then this function throws an error.
